    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-x-0 gap-y-0">
      ...
      <div className="text size-full px-8 py-12 lg:px-18 bg-neutral-2 flex flex-col justify-center ">
        <motion.p
          ...
          whileInView={"show"}
          viewport={{ once: true }}
          className="font-inter font-bold text-blue pb-4"
        >
          SALE UP TO 35% OFF
        </motion.p>
        <motion.h2
          ...
          whileInView={"show"}
          viewport={{ once: true }}
          className="font-poppins font-semibold text-[32px] md:text-[40px] text-neutral-7 leading-13 pb-4"
        >
        ...
        <motion.p
          ...
          whileInView={"show"}
          viewport={{ once: true }}
          className="font-inter font-normal md:text-xl leading-8 pb-6"
        >
