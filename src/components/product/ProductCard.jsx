    ...
    <div>
      <div className="img relative overflow-hidden group cursor-pointer mb-3.5">
        ...
        <div className="flex flex-col gap-y-2 absolute top-4 left-4 z-10">
          {tag && (
            <h3
              className={`py-1 px-3.5  font-inter font-bold text-neutral-1 ${tagColor || "bg-neutral-1 text-neutral-7"}`}
            >
              {tag}
            </h3>
          )}
          {discount && (
            <h3 className="py-1 px-3.5 bg-green font-inter font-bold text-neutral-1 w-fit">
              {discount}
            </h3>
          )}
        </div>
        <div className="p-4 size-full flex flex-col justify-between absolute top-full  group-hover:top-0 group-hover:opacity-100 opacity-0 transition-all duration-500 bg-neutral-3/50 *:">
          ...
          <button className="py-3 w-full bg-neutral-7 text-neutral-1 rounded-lg font-inter font-medium cursor-pointer">
            Add to cart
          </button>
        </div>
      </div>
      <div className="text">
        ...
        <div className="price flex items-center gap-x-2">
          ...
          {previousPrice && (
            <p className="font-inter font-normal text-sm text-neutral-4 line-through">
              {previousPrice}.00
            </p>
          )}
        </div>
